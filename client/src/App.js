...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Delivery date={coffee.date} setCustomCoffee={setCustomCoffee} customCoffee={customCoffee} />
      <button className="appBtn" onClick={() => sendData(customCoffee)}>
        Submit
      </button>
      {/* do a post and save data */}
      <p className="caffieneHistory">caffiene history: {caffieneHistory} espresso shots</p>
    </div>
  );
}
